...
mutate( y_test, activity <- activities[y_test$activity, 2] )
...
mutate( y_train, activity <- activities[y_train$activity, 2] )
...
### Creating data set with average values of per activities and subjects
